...
Check existing issues - Take a look at the existing issues to see if someone else has already reported the same problem.

Create a new issue - If your issue is unique, click on the "Issues" tab near the top of the page, and then click the "New issue" button.

Describe the issue - Provide as much detail as possible in the issue form:
...
Submit the issue - After you have filled out the form, click "Submit new issue" to create the issue. We will review it and respond as soon as possible.
